...
public class RcpProcessVO {
	/*
	 * create table recipe_process( pro_no int NOT NULL auto_increment, RCP_SEQ int
	 * NOT NULL, MANUAL01 text, MANUAL_IMG01 text, MANUAL02 text, MANUAL_IMG02 text,
	 * MANUAL03 text, MANUAL_IMG03 text, MANUAL04 text, MANUAL_IMG04 text, MANUAL05
	 * text, MANUAL_IMG05 text, MANUAL06 text, MANUAL_IMG06 text, MANUAL07 text,
	 * MANUAL_IMG07 text, MANUAL08 text, MANUAL_IMG08 text, MANUAL09 text,
	 * MANUAL_IMG09 text, MANUAL10 text, MANUAL_IMG10 text, MANUAL11 text,
	 * MANUAL_IMG11 text, MANUAL12 text, MANUAL_IMG12 text, MANUAL13 text,
	 * MANUAL_IMG13 text, MANUAL14 text, MANUAL_IMG14 text, MANUAL15 text,
	 * MANUAL_IMG15 text, MANUAL16 text, MANUAL_IMG16 text, MANUAL17 text,
	 * MANUAL_IMG17 text, MANUAL18 text, MANUAL_IMG18 text, MANUAL19 text,
	 * MANUAL_IMG19 text, MANUAL20 text, MANUAL_IMG20 text, );
	 */
