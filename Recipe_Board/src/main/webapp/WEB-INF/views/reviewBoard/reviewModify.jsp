		...
		<div class="row col-md-8" style="float: none; margin: 0 auto;">
			<form role="form" method="post" autocomplete="off" enctype="multipart/form-data">
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" name="rv_title" value="${reviewView.qa_rv_titletitle}" class="form-control">
					</div>
				</div>
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" name="user_name" value="${reviewView.user_name}" readonly">
					</div>
				</div>
				
				<div class="mb-3 form-floating">
					<textarea name="rv_content" class="form-control h-25" rows="10" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">
						${reviewView.rv_content}
					</textarea>
				...
				<div class="mb-3 col-auto" style="float: right">
						<a href="reviewList?num=1" role="button" class="btn btn-outline-secondary">취소</a>
						<button type="submit" class="btn btn-outline-success" id="btn-save">수정</button>
					</div>
			</form>
		</div>
