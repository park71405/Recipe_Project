		...
		<div class="row col-md-8" style="float: none; margin: 0 auto;">
			<form role="form" method="post" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							<input type="text" name="rv_title" class="form-control">
						</div>
					</div>
					...
					<div class="mb-3 form-floating">
						<textarea name="rv_content" class="form-control h-25" rows="10" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
