            					...
            					<div class="card-body py-5 px-md-5">
              						<form role="form" method="post" autocomplete="off">
                						...
                						<div class="form-outline mb-4">
                  							<input type="text" id="mana_id" name="mana_id" required="required" class="form-control" />
                  							<label class="form-label" for="mana_id">ID</label>
                						</div>

                						<!-- 비번 입력 -->
                						<div class="form-outline mb-4">
                  							<input type="password" id="mana_pw" name="mana_pw" required="required" class="form-control" />
                  							<label class="form-label" for="mana_pw">Password</label>
                						</div>
