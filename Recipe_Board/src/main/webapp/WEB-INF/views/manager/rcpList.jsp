	...
	<div class="container">
				...
				<ul class="pagination justify-content-end">
					<li class="page-item"><c:if test="${prev_m}">
							<a
								...
								href="/manager/rcpList?num=${rcpStartPageNum - 1}${rcpSearchTypeKeyword}"
					...
					<c:forEach begin="${rcpStartPageNum}" end="${rcpEndPageNum}"
						...
						<span> <c:if test="${rcpSelect != num}">
								<li class="page-item"><a
									class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
									href="/manager/rcpList?num=${num}${rcpSearchTypeKeyword}">${num}</a>
								</li>
					...
					<li class="page-item"><c:if test="${next_m}">
							<a
								class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
								href="/manager/rcpList?num=${rcpEndPageNum + 1}${rcpSearchTypeKeyword}"
		...
		<script>
			document.getElementById("rcpSearchBtn").onclick = function() {
				...
				location.href = "/manager/rcpList?num=1&rcpSearchType="
