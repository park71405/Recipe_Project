			...
			<div class="col-md-3 pt-5">
				...
				<ul class="list-unstyled text-light footer-link-list">
					...
					<li><i class="fa fa-phone fa-fw"></i> <a
						class="text-decoration-none" href="tel:010-020-0340">010-0000-1111</a>
					</li>
					<li><i class="fa fa-envelope fa-fw"></i> <a
						class="text-decoration-none" href="mailto:park71405@naver.com">park71405@naver.com</a>
					</li>
					<li><a
						class="text-decoration-none" target="_blank" href="https://github.com/park71405/Recipe_Project">GitHub</a>
					</li>
				</ul>
			</div>
