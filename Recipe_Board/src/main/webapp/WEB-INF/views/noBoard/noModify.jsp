		...
		<c:if test="${manager == null}">
			<script>
				swal('로그인 필요!', '로그인이 필요한 기능입니다. 로그인해주세요.', 'warning').then(function(){
					location.href = "../manager/manalogin";
				});
			</script>
		</c:if>
		...
		<div class="row col-md-8" style="float: none; margin: 0 auto;">
			<form role="form" method="post" autocomplete="off" enctype="multipart/form-data">
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							<input type="text" name="no_title" value="${noView.no_title}" class="form-control">
						</div>
					</div>		
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							<input type="text" name="mana_name" value="${manager.mana_name}" readonly>
						</div>
					</div>		
					
					<div class="mb-3 form-floating">
						<textarea name="qa_content" class="form-control h-25" rows="10" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">
							${noView.no_content}
						</textarea>
