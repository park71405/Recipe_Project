	...
	<div class="container">
						...
						<li class="pb-3"><a
							...
							<ul class="collapse show list-unstyled pl-3">
								<li><a href="/myPage/userInfo" class="text-decoration-none">회원
										정보</a></li>
								<li><a href="/myPage/rcpHeartList?num=1"
									class="text-decoration-none">찜 목록</a></li>
								<li><a href="/myPage/myReviewList?num=1"
									class="text-decoration-none">내 요리 후기</a></li>
							</ul></li>
					</ul>
				</div>
						...
						<ul class="pagination justify-content-end">
							<li class="page-item"><c:if test="${prev_m}">
									<a
										...
										href="/myPage/rcpHeartList?num=${rcpStartPageNum - 1}${rcpSearchTypeKeyword}"
							...
							<c:forEach begin="${rcpStartPageNum}" end="${rcpEndPageNum}"
								...
								<span> <c:if test="${rcpSelect != num}">
										<li class="page-item"><a
											class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
											href="/myPage/rcpHeartList?num=${num}${rcpSearchTypeKeyword}">${num}</a>
										</li>
							...
							<li class="page-item"><c:if test="${next_m}">
									<a
										class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark"
										href="/myPage/rcpHeartList?num=${rcpEndPageNum + 1}${rcpSearchTypeKeyword}"
		...
		<script>
			document.getElementById("rcpSearchBtn").onclick = function() {
				...
				location.href = "/myPage/rcpHeartList?num=1&rcpSearchType="
